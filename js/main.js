...
const translations = {
  es: {
    ...
    'sd.hero.body':   'Moment0 organiza eventos de speed dating íntimos en Roma Norte para personas reales que quieren conectar sin filtros ni algoritmos. 20 personas, perfiles verificados, mezcal incluido.',
  ...
  en: {
    ...
    'sd.hero.body':   'Moment0 organizes intimate speed dating events in Roma Norte for real people who want to connect without filters or algorithms. 20 people, verified profiles, mezcal included.',
